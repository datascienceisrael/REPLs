...
# Bug fixed by dan - in     def build_url_parameters(self,arguments):
#                    for the case - f arguments['time_range']:
#                    2018-06-05 - fix bug instead of &cdr we should have cdr
# Import Libraries
import sys
version = (3, 0)
...
class googleimagesdownload:
    ...
    def build_url_parameters(self,arguments):
        ...
        if arguments['time_range']:
            ...
            # dan 2018-06-05 - fix bug instead of &cdr we should have cdr
            time_range = 'cdr:1,cd_min:' + d['time_min'] + ',cd_max:' + d['time_min']
        else:
            time_range = ''
